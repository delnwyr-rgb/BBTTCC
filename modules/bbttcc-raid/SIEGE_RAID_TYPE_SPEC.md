...
**Status:** SIGNED OFF 2026-05-22 — Phases A · A.5 · B · C · **D (COMPLETE)** · **E (COMPLETE)** SHIPPED+synced 2026-05-22/23. **Phase F IN PROGRESS: F.1 + F.2 SHIPPED + synced** (F.1=`0ada94a`, F.2=`d3a5a57`); **F.3 Event Deck BUILT** 2026-05-23 (pending F5 + selftest). **NEXT: F.4 player Siege HUD — the last piece of Phase F.**
**Parent specs:**
...
**F.3 — Event Deck content + engine — ✅ BUILT 2026-05-23** (`data/siege-events.json` + `scripts/siege-events.js` ~288 LOC; pending F5 + selftest, not yet synced)
