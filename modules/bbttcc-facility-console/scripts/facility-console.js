...
const FACILITY_PRESETS = {
  bunker: {
    ...
    raidBonuses: {
      defenderDcBonus: 1,
      attackerExtraOpCost: { violence: 10, logistics: 0 },
      maxDefenderUnits: 2,
      notes:
      ...
      upgradesRaw: `[
  {
    ...
    "opCost": { "logistics": 10, "economy": 10 },
  ...
  tower: {
    ...
    raidBonuses: {
      defenderDcBonus: 2,
      attackerExtraOpCost: { violence: 0, logistics: 10 },
      maxDefenderUnits: 3,
      notes:
  ...
  castle: {
    ...
    raidBonuses: {
      defenderDcBonus: 3,
      attackerExtraOpCost: { violence: 20, logistics: 10 },
      maxDefenderUnits: 5,
      notes:
      ...
      upgradesRaw: `[
  {
    ...
    "tier": 1,
    "structureDefenseRatingBonus": 1,
    "opCost": { "logistics": 10, "economy": 20 },
      ...
      turnEffectsRaw: `[
  {
    ...
    "opDelta": { "economy": 10, "logistics": 10 }
  }
]`,
      resolutionHooksRaw: `{
  "onDestroyedOutcome": "salt_the_earth",
...
// All opCost / opDelta values are MARKS (1 OP = 10 marks).
const FACILITY_UPGRADE_PRESETS = [
  ...
  },
  {
    ...
    tier: 1,
    structureDefenseRatingBonus: 0,
    opCost: { logistics: 10, intrigue: 10 },
  ...
  },
  {
    ...
    tier: 2,
    structureDefenseRatingBonus: 0,
    opCost: { economy: 20, logistics: 10 },
