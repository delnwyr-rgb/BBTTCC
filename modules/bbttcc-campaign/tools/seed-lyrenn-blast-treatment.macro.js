...
(async () => {
  ...
  replaceIn("lyrenn_word_treeline", /'Trees\. Moving\. Come\.'(?! — and, pressed smaller underneath: 'Toward you\.')/, "'Trees. Moving. Come.' — and, pressed smaller underneath: 'Toward you.'"); // lookahead = idempotent (it appended once per run before 2026-09-15)
