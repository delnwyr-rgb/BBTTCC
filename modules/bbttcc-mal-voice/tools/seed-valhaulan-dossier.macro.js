...
(async () => {
  ...
  const PAGES = [
    ...
    { name: "Patter — The Tally", knownBy: "Patter", after: A.changed, body:
      `Patter saw the green pulse before anyone — partners notice chest-height things. She's keeping a private tally of every place Pip hesitates where he never used to, and the tally is not zero, and she hasn't told Mara because telling Mara makes things REAL and she is not ready for this to be real.` },
