...
class BBTTCCTerritoryModule {
    ...
    static onRenderSceneControls(app, html, data) {
        try {
            console.log(`${this.MODULE_ID} | renderSceneControls called`, { isGM: game.user.isGM, hasData: !!data, hasControls: !!data?.controls });
            ...
            if (game.user.isGM && data?.controls) {
                ...
                console.log(`${this.MODULE_ID} | Territory controls added to scene controls`, territoryControls);
            }
        } catch (error) {
