    ...
    async getData(options) {
        ...
        try {
            ...
            context.opsLabels = {
                ...
                logistics: game.i18n.localize("BBTTCC.OPs.Logistics") || "Logistics",
                culture: game.i18n.localize("BBTTCC.OPs.Culture") || "Culture",
                faith: game.i18n.localize("BBTTCC.OPs.Faith") || "Faith"
            };
