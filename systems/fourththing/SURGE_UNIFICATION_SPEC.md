...
**Roster progress (6 of 9 redesigned):**
...
- ⬜ **Pactkeeper** (caster) — NEXT.
- ⬜ **Wyrdlens Adept** (caster) · ⬜ **Cosmic Linguist** (caster).
...
7. **Live-test the redesigned classes**, settle §6, then template the remaining roster: **Pactkeeper** (NEXT — caster; pick archetype + generator), **Wyrdlens Adept**, **Cosmic Linguist**.
