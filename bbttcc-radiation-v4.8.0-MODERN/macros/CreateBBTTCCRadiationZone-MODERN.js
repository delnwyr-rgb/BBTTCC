/**
 * BBTTCC Radiation Zone Creator Macro - MODERN v4.8.0
            ...
            const dialog = new Dialog({
                ...
                buttons: {
                    apply: {
                        ...
                        callback: async (html) => {
                            try {
                                const zoneType = html.find('#zone-type').val();
                                const customIntensity = html.find('#custom-intensity').val();
                ...
                render: (html) => {
                    ...
                    html.find('#zone-type').change(function() {
                        const selectedType = $(this).val();
                        const zoneData = ZONE_TYPES[selectedType];
                        if (zoneData) {
                            html.find('#custom-intensity').val(zoneData.intensity);
                        }
                    });
                }
            });
