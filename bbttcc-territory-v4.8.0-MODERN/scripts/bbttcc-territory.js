/**
 * BBTTCC Territory Control Module v4.8.0 - MODERN
...
class BBTTCCTerritoryModule {
    ...
    static async initialize() {
        ...
        try {
            ...
            ui.notifications.error('BBTTCC Territory failed to initialize. Check console for details.');
            throw error;
        }
    }
    ...
    static onRenderSceneControls(controls) {
        try {
            ...
            if (game.user.isGM) {
                ...
                controls.push(territoryControls);
            }
        } catch (error) {
...
Hooks.once('init', async () => {
    console.log('BBTTCC Territory | Initializing v4.8.0-MODERN...');
